...
//	UNITY_DEFINE_INSTANCED_PROP(float4, _PositionTexture_ST)
//	UNITY_DEFINE_INSTANCED_PROP(float4, _NormalTexture_ST)
...
//	UNITY_DEFINE_INSTANCED_PROP(float, _RowsPerFrame)
